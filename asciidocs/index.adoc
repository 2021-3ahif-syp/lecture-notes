...
=== Übung: Erstellen der User Stories und der ersten Tasks
...
image:one-repo-per-aggregate.png[]
...
=== Besprechen des SYP3-Curriculums

=== Scrum-Foliensatz (Wiederholung)
...
=== Automatisierung (gh-actions, Jenkins)
...
== 2021-04-26 docker-compose Gruppe B

image:web-server.png[]

image:http-header-body.png[]

image:ports-sockets.png[]

* https://ssaurel.medium.com/create-a-simple-http-web-server-in-java-3fc12b29d5fd[Create a simple HTTP Web Server in Java, window="_blank"]

image:java-ins-internet.png[]


image:servlet-filter.png[]

* Source: https://docstore.mik.ua/orelly/xml/jxslt/ch08_04.htm[Servlet Filters, window="_blank"]
* https://www.oracle.com/java/technologies/filters.html[The Essentials of Filters, window="_blank"]


== 2021-05-03 docker-compose Gruppe A

* Bis zu Servlets (SimpleServlet, BlockingServlet)


== 2021-05-03 docker-compose Gruppe B
